...
#'
#' `visualize_q20_dedicated_team()` visualizes question data.
#'
#' @return plot output.
#'
#' @examples
#' visualize_q20_dedicated_team();
#'
#' \dontrun{
#' visualize_q20_dedicated_team();
#' }
#'
#' @export
visualize_q20_dedicated_team <- function() {
  ...
  series_titles = c(
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$Q20R1), "Dedicated - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$Q20R2), "Dedicated - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$Q20R3), "Dedicated - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$Q20R4), "Dedicated - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$Q20R5), "Dedicated - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$Q20R6), "Dedicated - ")
  );

  # Prepare the vector with the option codes.
  series_codes = stringr.tools::str_prefix(1:6, "R");
  ...
  value_labels = c("Predominantly shared",
                 "Balanced",
