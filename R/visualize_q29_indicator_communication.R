#' Visualize question #29: indicator communication.
#' References:
...
#'
#' @examples
#' visualize_q29_indicator_communication();
#'
#' \dontrun{
#' visualize_q29_indicator_communication();
#' }
#'
#' @export
visualize_q29_indicator_communication <- function() {
  ...
  series_titles = c(
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$R1), "IndComm - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$R2), "IndComm - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$R3), "IndComm - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$R4), "IndComm - "),
    stringr.tools::str_unprefix(sjlabelled::get_label(question_data$R5), "IndComm - ")
  );
